...
void PrintUsage()
{
  ...
  << "[--Debug=false] Runtime Boolean option for developers to place program in debugging mode printing statements at various spots in the program" << G4endl
  << "[-d]" << G4endl
  << "[--Force_Isotropic=true] Forces nrf isotropic emission." << G4endl
  << "[-i]" << G4endl
  << "[--NRF=true] IF set to false NRF Physics will be removed from physicsList! The default is set to true." << G4endl
  << "[-n]" << G4endl
  << "[--Print_Events=false]  Runtime Boolean option to print event tracker to std::cout instead of G4cout to file" << G4endl
  << "[-p]" << G4endl
  << "[--Detector_Response_Input=false] Runs Mantis Simulation with Detector Response Function Input" << G4endl
  << "[-r]" << G4endl
  << "[--Print_Standalone_Data=false] Calls G4NRF to print a file of NRF Energies (takes up to 15 min) not recommended for non-developers" << G4endl
  << "[-s]" << G4endl
  << "[--Detector_Response_File=DetectorResponse.root] Input File with Detector Response Function TProfile" << G4endl
  << "[--Verbose=false] Sets NRF Physics Verbosity" << G4endl
  << "[-v]" << G4endl
  << G4endl << "Testing Options: Detector Response, Bremsstrahlung Test, Resonance Test" << G4endl << G4endl
  << "[--Detector_Response_Test=false] Create Detector Response Function" << G4endl
  << "[-t1]" << G4endl
  << "[--Brem_Test=false] For creating a bremsstrahlung beam for a secondary simulation input. Requires -a energy flag to be passed with max bremsstrahlung energy" << G4endl
  << "[-t2]" << G4endl
  << "[--Resonance_Test=false] Tests Resonance energies by having the input spectrum a normal distribution centered on Uranium resonance energies." << G4endl
  << "[-t3]" << G4endl
  << "[--Sample_Energy_Range=false] Samples from a normal distribution centered on user's energy." << G4endl
  << "[-t4]" << G4endl
